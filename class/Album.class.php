...
class Album
{
	...
	public function getAlbumList($sortby=NULL,$limit=NULL,$autocompletetext=NULL)
   	{		
		...
		$query = "SELECT PKALBUMID,FKUSERID,FKPARENTID,NAME,USERNAME,DESCRIPTION,ADDRESS,PRIVACY,LATITUDE, LONGITUDE, RADIOUS, URLLARGE, URLMEDIUM, URLSMALL, URLTHUMB, POSTDATE FROM TBLALBUM 
	...
	public function getAlbumListAsDistance($sortby=NULL,$limit=NULL,$lat,$lng)
   	{		
		...
		$query = "SELECT PKALBUMID,FKUSERID,NAME,USERNAME,DESCRIPTION,ADDRESS,PRIVACY,POSTDATE,RADIOUS,
	...
	public function getAlbumListNearBy($limit, $lat, $lng){
		...
		$query = "SELECT b.PKALBUMID,b.FKUSERID,b.FKPARENTID,b.FKCATEGORYID,b.LATITUDE, b.LONGITUDE, b.NAME,b.USERNAME,b.DESCRIPTION,b.ADDRESS,b.PRIVACY,b.POSTDATE,b.RADIOUS, p.NAME as 'PARENTNAME', (SELECT COUNT(PKPHOTOID) FROM TBLPHOTO WHERE FKALBUMID = b.PKALBUMID) as 'PHOTOSIZE', 
		...
		WHERE  b.PRIVACY='1'  AND b.ISPARENT = '0'
	...
	public function getAllAlbumListNearBy($currentPage,$lat,$lng,$pkAlbumID)
   	{		
		...
		$query = "SELECT b.PKALBUMID,b.FKUSERID,b.FKPARENTID,b.FKCATEGORYID,b.NAME,b.USERNAME,b.DESCRIPTION,b.ADDRESS,b.PRIVACY,b.POSTDATE,b.RADIOUS, p.NAME as 'PARENTNAME', (SELECT COUNT(PKPHOTOID) FROM TBLPHOTO WHERE FKALBUMID = b.PKALBUMID) as 'PHOTOSIZE', 
	...
	public function getParentAlbumListNearBy($currentPage,$lat,$lng)
   	{		
		...
		//To search by kilometers instead of miles, replace 3959 with 6371. 
		$query = "SELECT b.PKALBUMID,b.FKUSERID,b.FKPARENTID,b.FKCATEGORYID,b.NAME,b.USERNAME,b.DESCRIPTION,b.ADDRESS,b.PRIVACY,b.POSTDATE,b.RADIOUS, '' as 'PARENTNAME', b.FKPARENTID,
