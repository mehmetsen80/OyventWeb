...
<head>
	<title>Discover Social Media Photos</title> 	
        ...
        <div class="maincontainer">
			...
			<div class="main">
                ...
                <div class="center">
        			...
        			<h1>Discover Social Media Photos </h1>
        			
        			<form  id="formHashTag"  method="post" name="formHashTag" >
  	...
  	switch($social){
          ...
          foreach ($media->data as $data) {
            	$content .= "<li>
						   ...
						   <div class='add2album'>
						   <a class='btn'  data-instagramid='{$data->id}' data-smallurl='{$data->images->thumbnail->url}' data-mediumurl='{$data->images->low_resolution->url}' data-largeurl='{$data->images->standard_resolution->url}' data-thumburl=''  data-ownedby='{$data->user->username}' data-caption='{$data->caption->text}'  onClick='addInstagramPhoto(this)' >Add to Album</a>					   						   
						    <div style='width:100%; padding:2px; text-align:right;'>								
									<img height='16' width='16' src='/images/instagram-icon-32.png' >
							</div> 
		 ...
		 case 1: //twitter
				...
				$url = 'https://api.twitter.com/1.1/search/tweets.json';
					$requestMethod = 'GET';
					$getfield = '?q='.$tag.'%20filter:images&result_type=recent&count=100&include_entities=true&include_retweets=false';					
