        ...
        <div class="container">
			...
			<div class="main">
                ...
                <div class="grid">
                    ...
                    <div class="input" style='font-size:18px;' >http://oyvent.com/<input name="txtUsername" class="txt" style='width:232px;' value=<?php echo isset($albumID)? $album->username: "url" ?>  type="text" id="txtUsername"  maxlength="20" /></div>  
