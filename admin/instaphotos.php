...
echo "<br>";
echo print_r($instadetails);
echo "<br>";

if(isset($instadetails))
echo "not null:".$instadetails;
else
echo "instadetails is null";*/
...
<head>
    ...
    <script src="/js/InstaPhotos.js"></script>
			...
			<div class="main">
				...
				<section id="contentArea"><!-- This is where all the content goes -->
                	...
                	<div class="center">
        				...
        				<h1>My Instagram Photos <span style="font-weight:bold;"></span></h1>
        ...
        <?php		 
         		 ...
         		 foreach ($media->data as $data) {
					...
					$firstdate =  (isset($firstdate) && $firstdate!='')?$firstdate."<br>":"";
            			...
            			$content .= "<li>
						<a   rel='fancybox-thumb' href='{$data->images->standard_resolution->url}' class='fancybox-thumb' >
