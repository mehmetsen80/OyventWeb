...
<head>
	<title>My Twitter Home Timeline Photos</title>
    ...
    <script src="/js/TwitTimeline.js"></script>
...
<?php include("menu.php"); ?>
			...
			<div class="main">
				<section id="contentArea"><!-- This is where all the content goes -->
                	...
                	<div class="center">
                    	...
                    	<img src="/images/twitter.png" alt="Instagram logo">
        				<h1>My Timeline Photos <span style="font-weight:bold;"></span></h1>
        ...
        <br />-->
         ...
         <?php 
					...
					$requestMethod = 'GET';
					$getfield = '?count=100&exclude_replies=true&include_entities=true';
