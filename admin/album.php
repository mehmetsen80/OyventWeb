                ...
                <div style='float:left; width:100%; clear:both; margin:4px; margin-top:60px; text-align:center;'>
				 ...
				 foreach($photos as $photo){
					...
					if(isset($photo["FKALBUMID"])){
						$strSocialMedia .= "  <a class='blue' style='font-size:14px;' title='".$photo['ALBUMNAME']."' href='/admin/album.php?albumID=".$photo["FKALBUMID"]."' ><i class='icon_tag_alt'></i> ".substr($photo['ALBUMNAME'],0,32)."</a>";
					}
