...
var ddData = [
{
	value: 0,
	selected: true,	
	imageSrc: "/images/instagram-icon-32.png"
},
{
	value: 1,
	selected: false,
...
function initSocialDropdown(){
	...
	//look at http://designwithpc.com/Plugins/ddSlick for more details
	$('#ddlSocialNetwork').ddslick({
		data:ddData,
		width:70,		
		...
		onSelected: function(data){
			...
			$("#social").val(data.selectedData.value);
		} 
	});	
}
...
function loadMoreTwitter(obj){
		...
		var info = "tag="+tag+"&max_id="+maxid+"&processType=GETTWIITERSEARCHLIST&albumID="+albumID+"&nocache="+Math.random();
